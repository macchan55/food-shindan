...
const styles = StyleSheet.create({
  page: { fontFamily: "NotoSansJP", fontSize: 9, padding: 32, color: COLORS.ink },
  title: { fontSize: 16, textAlign: "center", marginBottom: 4, fontWeight: 700 },
  dateLine: { fontSize: 8, textAlign: "right", marginBottom: 4, color: COLORS.muted },
  ...
  workBlock: { marginTop: 8, padding: 8, border: `0.5pt solid ${COLORS.border}` },
  workHeader: { fontSize: 9.5, fontWeight: 700, marginBottom: 2 },
  workMeta: { fontSize: 8, color: COLORS.muted, marginBottom: 4 },
...
export function ChronologicalTemplate({ data }: { data: ResumePdfData }) {
